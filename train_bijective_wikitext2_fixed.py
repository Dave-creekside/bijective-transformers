#!/usr/bin/env python3
"""
FIXED: Training script for bijective discrete diffusion model on WikiText-2.
Demonstrates real-world application with proper device compatibility.
"""
...
# Import FIXED device-aware corruption
...
def train_bijective_model():
    """Train bijective discrete diffusion model with FIXED device compatibility."""
    print("🚀 Training Bijective Discrete Diffusion Model (DEVICE FIXED)")
    print("=" * 70)
    ...
    noise_scheduler = NoiseScheduler(num_timesteps=1000, device=torch.device(device))
    ...
    print("🛠️  DEVICE COMPATIBILITY FIXED - No more device errors!")
    ...
    print(f"   Corruptor device: {corruptor.noise_scheduler.device}")
...
if __name__ == "__main__":
    try:
        ...
        print("\n✅ SUCCESS: Bijective model training completed with FIXED device compatibility!")
        print("🛠️  No more device mismatch errors!")
    except Exception as e:
